...
//  Out of this World
//
//  Created by Angeleah Daidone on 3/13/14.
...
#import "OWSpceImageViewController.h"
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        if ([segue.destinationViewController isKindOfClass: [OWSpceImageViewController class]])
        {
            OWSpceImageViewController *nextViewController = segue.destinationViewController;
...
-(void)addSpaceObject:(OWSpaceObject *)spaceObject
{
    ...
    //will save to nsuser defaults here.
    ...
    [spaceObjectsAsPropertyLists addObject:[self spaceObjectPropertyList:spaceObject]];
...
-(NSDictionary *)spaceObjectPropertyList:(OWSpaceObject *)spaceObject
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.textColor = [UIColor colorWithWhite:.05 alpha:1.0];
